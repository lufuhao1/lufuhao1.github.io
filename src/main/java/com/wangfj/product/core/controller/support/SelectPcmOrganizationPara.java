...
public class SelectPcmOrganizationPara {
	...
	public String toString() {
		return "SelectPcmOrganizationPara [parentSid=" + parentSid + ", groupSid=" + groupSid
				+ ", organizationName=" + organizationName + ", organizationCode="
				+ organizationCode + ", organizationType=" + organizationType + ", storeType="
				+ storeType + ", organizationStatus=" + organizationStatus + ", currentPage="
